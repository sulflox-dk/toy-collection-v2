...
<div class="row mb-3 align-items-center">
    <div class="col-md-4 mb-2 mb-md-0">
        <div class="input-group">
            ...
            <input type="text" class="form-control" id="search-input" placeholder="Search universes...">
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Universe</h5>
            ...
            <form id="universe-form">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="name" required placeholder="e.g. Star Wars">
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Description</label>
                        <textarea class="form-control" name="description" rows="2" placeholder="Brief description of the universe..."></textarea>
                    </div>
